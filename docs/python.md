  ...
  <div class="inner">
    <div class="cols">
      <div>
        ...
        并在答辩中说清每一行代码的作用。</p>
        <div class="cta-row">
          <a class="pyv2-btn primary" href="python/v2/m0/">从 M0 开始学习 →</a>
...
<div class="pyv2" data-pyv2-page>
  ...
  <div class="pyv2-path">
    <a class="pyv2-mod-card" href="python/v2/m0/" data-anim><div class="glow"></div>
    ...
    <a class="pyv2-mod-card" href="python/v2/m1/" data-anim><div class="glow"></div>
    ...
    <a class="pyv2-mod-card" href="python/v2/m2/" data-anim><div class="glow"></div>
    ...
    <a class="pyv2-mod-card" href="python/v2/m3/" data-anim><div class="glow"></div>
    ...
    <a class="pyv2-mod-card" href="python/v2/m4/" data-anim><div class="glow"></div>
      <span class="mid">M4 · L16–L18</span><b>工程化</b>
      <span>虚拟环境与依赖、AI 生成代码的审查重构、模块化项目结构与配置管理</span>
      <span class="lessons">3 课时 · V029–V033</span>
    </a>
    <a class="pyv2-mod-card" href="python/v2/m5/" data-anim><div class="glow"></div>
    ...
    <a class="pyv2-mod-card" href="python/v2/m6/" data-anim><div class="glow"></div>
    ...
    <a class="pyv2-mod-card" href="python/v2/m7/" data-anim><div class="glow"></div>
...
<div class="pyv2" data-pyv2-page>
  ...
  <div class="pyv2-graph-wrap">
    ...
    {
      "modules": [
        {"id": "m0", "label": "M0 导论", "color": "#38bdf8", "r": 26, "href": "python/v2/m0/", "desc": "AI 时代为什么学编程；现场做出第一个 AI 应用"},
        {"id": "m1", "label": "M1 环境工具", "color": "#22d3ee", "r": 24, "href": "python/v2/m1/", "desc": "命令行 · AI 工具全家桶 · 大模型 API 初体验 · Git"},
        {"id": "m2", "label": "M2 语言核心", "color": "#34d399", "r": 26, "href": "python/v2/m2/", "desc": "类型 · 数据结构 · 控制流 · 函数 · IO 异常 · 类"},
        {"id": "m3", "label": "M3 数据获取", "color": "#fbbf24", "r": 24, "href": "python/v2/m3/", "desc": "HTTP · requests · 爬虫精要 · Pandas 可视化"},
        {"id": "m4", "label": "M4 工程化", "color": "#f472b6", "r": 22, "href": "python/v2/m4/", "desc": "虚拟环境 · 代码审查 · 模块化结构"},
        {"id": "m5", "label": "M5 AI开发", "color": "#a78bfa", "r": 30, "href": "python/v2/m5/", "desc": "Prompt · Function Calling · RAG · Agent · FastAPI"},
        {"id": "m6", "label": "M6 综合项目", "color": "#f87171", "r": 27, "href": "python/v2/m6/", "desc": "14 课时：选题 → 冲刺 → 答辩"},
        {"id": "m7", "label": "M7 展望", "color": "#94a3b8", "r": 20, "href": "python/v2/m7/", "desc": "技术版图 · 进阶路线 · 职业发展"}
      ],
      "lessons": [
