...
<img src="/img/puttygen_start.png" alt="puttygen">
</p>

点击 `Generate` 并持续晃动鼠标，即可完成公私钥生成。

<p style="text-align:center">
<img src="/img/putty_keys.png" alt="puttygen">
</p>
